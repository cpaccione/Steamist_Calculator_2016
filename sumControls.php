...
function checkcontrols ($cpcontrol) { 
				global $cp_controlexists;
				$cppos = substr($cpcontrol, 0,2);
				
				if ($cppos == 'CP') {
				$controlexists = 'true';
				$cp_controlexists = 'true';
				return $cp_controlexists;
				}
...
<?php if ($totalRows_rsSumControls > 0) { // Show if recordset not empty ?>
		<table class="tablegrid" width="100%" border="0" cellpadding="5" cellspacing="0">
				<tr>
						<td><strong><a href="?genqty=<?php echo $_GET[genqty]; ?>&amp;button3=<?php echo $_GET[button3]; ?>&amp;genid=<?php echo $_GET[genid]; ?>&amp;gen=<?php echo $_GET[gen]; ?>&amp;genref=<?php echo $_GET[genref]; ?>&amp;section=3&amp;genstack=<?php echo $_GET['genstack']; ?>">Controls</a></strong></td>
				...
				<?php do { ?>
						<tr>
								<td><a class="controls" href="#controls<?php echo $row_rsSumControls['optid']; ?>"> <?php echo $row_rsSumControls['name']; ?>-<?php echo $row_rsSumControls['model']; ?></a> <?php 
										 ...
										 checkcontrols($row_rsSumControls['model']);
						...
						<img class="alignleft" name="img" src="<?php echo $row_rsSumControls['image']; ?>"  alt="" />
						<?php } ?>
								...
								<td align="right">$<?php echo $row_rsSumControls['controloptionvalue'] ; ?></td>
								<td align="right"><?php echo $row_rsSumControls['optionqty']; ?></td>
								<td align="right">$<?php 
