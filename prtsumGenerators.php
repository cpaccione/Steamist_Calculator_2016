...
<table class="tablegrid" width="100%" border="0" cellpadding="5" cellspacing="0">
		...
		<?php do { ?>
				<tr>
						<td><div class="generators"> <?php echo $row_rsGenerators['series']; ?>-<?php echo $row_rsGenerators['model']; ?></div>
			<!--					<div style="display: none;">  -->
										<div id="<?php echo $row_rsGenerators['id']; ?>" style="width:400px;overflow:auto;"> 
										<?php if ($row_rsGenerators['image'] <> '') {?>
						<img class="alignleft" name="img" src="http://www.steamist.com<?php echo $row_rsGenerators['image']; ?>"  alt="" />
						<?php } ?>
			...
			<!--							</div>  -->
						...
						<td valign="top" align="right" style="width:50px;">$<?php echo $row_rsGenerators['price'] ; ?></td>
						<td valign="top" align="right" style="width:50px;"><?php echo $varGenQty; ?></td>
						<td valign="top" align="right" style="width:50px;">$<?php 
