...
<?php if ($totalRows_rsSumAccessories > 0) { // Show if recordset not empty ?>
		<table class="tablegrid" width="100%" border="0" cellpadding="5" cellspacing="0">
				...
				<?php do { ?>
						<tr>
								<td><div class="accessories"><?php echo $row_rsSumAccessories['name']; ?>-<?php echo $row_rsSumAccessories['model']; ?><?php echo ' - <span style="text-transform:capitalize;">' . $row_rsSumAccessories['finishlabel'] . '</span>'; ?> </div>
				<!--						<div style="display: none;">  -->
						...
						<img class="alignleft" name="img" src="http://www.steamist.com<?php echo $row_rsSumAccessories['image']; ?>"  alt="" />
						<?php } ?>
				...
				<!--								</div>  -->
								...
								<td valign="top" align="right">$<?php echo $row_rsSumAccessories['controloptionvalue'] ; ?></td>
								<td valign="top" align="right"><?php echo $row_rsSumAccessories['optionqty']; ?></td>
